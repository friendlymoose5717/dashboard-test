...
async function getOutgoingDelegations(user) {
    ...
    return (delegs || []).map(d => {
        const vs = parseFloat(d.vesting_shares);
        const hp = shares ? (fund * vs) / shares : 0;
        return { to: d.delegatee, hp };
    });
}
    ...
    dash.innerHTML = `
        <div class="grid">
            <div id="repCard" class="card">
                <div class="label">${BLOCK_LABELS.repCard}</div>
                <div class="value">${rep.toFixed(2)}</div>
            </div>
            <div id="ageCard" class="card">
                <div class="label">${BLOCK_LABELS.ageCard}</div>
                <div class="value">${age}</div>
            </div>
            <div id="hpCard" class="card">
                <div class="label">${BLOCK_LABELS.hpCard}</div>
                <div class="value">${hp.toFixed(3)}</div>
            </div>
            <div id="delegationPctCard" class="card">
                <div class="label">${BLOCK_LABELS.delegationPctCard}</div>
                <div class="value">${delegationPct.toFixed(1)}%</div>
            </div>
            <div id="keCard" class="card">
                <div class="label">${BLOCK_LABELS.keCard}</div>
                <div class="value">${ke.krampus.toFixed(4)}</div>
            </div>
            <div id="postsCard" class="card">
                <div class="label">${BLOCK_LABELS.postsCard}</div>
                <div class="value">${pc.posts}</div>
            </div>
            <div id="commentsCard" class="card">
                <div class="label">${BLOCK_LABELS.commentsCard}</div>
                <div class="value">${pc.comments}</div>
            </div>
            <div id="ratioCard" class="card">
                <div class="label">${BLOCK_LABELS.ratioCard}</div>
                <div class="value">${pc.ratio.toFixed(2)}</div>
            </div>
            <div id="transfersCard" class="card">
                <div class="label">${BLOCK_LABELS.transfersCard}</div>
                <div class="value">
                    ${transferSummary.hive.toFixed(3)} HIVE<br>
                    ${transferSummary.hbd.toFixed(3)} HBD
                </div>
            </div>
            <div id="downvotesCard" class="card">
                <div class="label">${BLOCK_LABELS.downvotesCard}</div>
                <div class="value">${Object.values(dv).reduce((a,b)=>a+b,0)}</div>
            </div>
            <div id="uniqueUpvotesCard" class="card">
                <div class="label">${BLOCK_LABELS.uniqueUpvotesCard}</div>
                <div class="value">${uniqueUpvotes}</div>
            </div>
            <div id="blacklistCard" class="card">
                <div class="label">${BLOCK_LABELS.blacklistCard}</div>
                <div class="value">${isBlacklisted ? "YES" : "NO"}</div>
            </div>
        </div>
